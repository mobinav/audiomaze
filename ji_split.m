function pieces = ji_split(str,delimiter)
% ji_split   split a string on an arbitrary delimiter
%
%   pieces = ji_split(str,delimeter)
%
...
if iscell(str),
    for i = 1:length(str),
        pieces{i} = ji_split(str{i},delimiter);
    end
    return
end
...
ji_require(ischar(str)&ischar(delimiter),'Inputs must be strings')
